...
def set_arguments():
    ...
    parser.add_argument('--keep_folder_structure', action='store_true', help="Recreate folder structure based on package version.")
...
def get_artifacts_from_location(package_version=None, package_name=None, keep_folder_structure=False):
    """
    ...
    :param keep_folder_structure: `Bool` specify if the folder structure should be recreated.
